    ...
    with st.spinner(f"Searching JioMart for '{query}'..."):
        try:
            ...
            payload = {
                "query": query,
                "pageSize": 10,
                "visitorId": "anonymous-8608f31f-9d42-4dac-b889-42f4376983c4",
                "canonicalFilter": "attributes.status:ANY(\"active\") AND (attributes.mart_availability:ANY(\"JIO\", \"JIO_WA\")) AND (attributes.available_regions:ANY(\"PANINDIABOOKS\", \"PANINDIACRAFT\", \"PANINDIADIGITAL\", \"PANINDIAFASHION\", \"PANINDIAFURNITURE\", \"FRER\", \"PANINDIAGROCERIES\", \"PANINDIAHOMEANDKITCHEN\", \"PANINDIAHOMEIMPROVEMENT\", \"PANINDIAJEWEL\", \"PANINDIASTL\", \"PANINDIAWELLNESS\")) AND ((attributes.inv_stores_1p:ANY(\"ALL\", \"U253\", \"SANR\", \"SANS\", \"SURR\", \"SANQ\", \"S4LI\", \"VLOR\", \"SF11\", \"SF40\", \"SX9A\", \"SC28\", \"SK1M\", \"R810\", \"R696\", \"SJ93\", \"R396\", \"SE40\", \"S3TP\", \"SLKO\", \"R406\") OR attributes.inv_stores_3p:ANY(\"ALL\", \"groceries_zone_non-essential_services\", \"general_zone\", \"groceries_zone_essential_services\", \"fashion_zone\", \"electronics_zone\"))) AND ( NOT attributes.vertical_code:ANY(\"ALCOHOL\"))",
                ...
                "userInfo": {"userId": "72D48A4D4871F10564084BB76BE6931ABB13E11668A904CF5D23667BF162EF6B"},
